                ...
                <div class="slider owl-carousel">
                    <div class="slider-item style2">
                        <div class="item-text">
                            ...
                            <div class="content-item">
                                <div class="price">
                                    ...
                                    <span class="btn-shop">
												<a href="#" title="">SHOP NOW <img src="<?php echo public_url()?>/front/images/icons/right-2.png" alt=""></a>
											</span>
                        ...
                        <div class="item-image">
                            ...
                            <img src="<?php echo public_url()?>/front/images/slider/03.png" alt="">
                        </div>
                        <div class="clearfix"></div>
                    </div><!-- /.slider -->
                    <div class="slider-item">
                        ...
                        <div class="item-image">
                            <img src="<?php echo public_url()?>/front/images/slider/01.png" alt="">
                        </div>
                        <div class="clearfix"></div>
                    </div><!-- /.slider -->
                    <div class="slider-item style2">
        ...
        <div class="box-product">
            <div class="row">
                ...
                <?php endif; ?>
                    <div class="product-box">
                        <div class="imagebox">
                            <?php $image_list =$newproduct->image_list != NULL ? json_decode($newproduct->image_list->load()) : NULL;?>
                            <ul class="box-image <?php if(is_array($image_list)):?> owl-carousel-1 <?php endif;?>">
                                <li>
                                    <a href="<?php echo base_url('product/detail/'.$newproduct->id)?>" title="">
                                        <img src="<?php echo base_url('upload/product/'.$newproduct->image_link);?>" alt="">
                                    </a>
                                </li>
                            ...
                            <div class="box-content">
                                ...
                                <div class="product-name">
                                    <a href="<?php echo base_url('product/detail/'.$newproduct->id)?>" title=""><?php echo $newproduct->name; ?></a>
                                </div>
                                <div class="price">
                            ...
                            <div class="box-bottom">
                                <div class="btn-add-cart">
                                    <a href="<?php echo base_url('cart/add/'.$newproduct->id) ?>" title="">
                    ...
                    <div class="product-box">
                        <div class="imagebox">
                            ...
                            <ul class="box-image owl-carousel-1">
                                <li>
                                    <a href="#" title="">
                                        <img src="<?php echo public_url()?>/front/images/product/other/08.jpg" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#" title="">
                    ...
                    <div class="product-box">
                        <div class="imagebox">
                            <ul class="box-image owl-carousel-1">
                                <li>
                                    <a href="#" title="">
                                        <img src="<?php echo public_url()?>/front/images/product/other/06.jpg" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#" title="">
                    ...
                    <div class="product-box">
                        <div class="imagebox">
                            <ul class="box-image owl-carousel-1">
                                <li>
                                    <a href="#" title="">
                                        <img src="<?php echo public_url()?>/front/images/product/other/02.jpg" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#" title="">
                    ...
                    <div class="product-box">
                        <div class="imagebox">
                            ...
                            <ul class="box-image owl-carousel-1">
                                <li>
                                    <a href="#" title="">
                                        <img src="<?php echo public_url()?>/front/images/product/other/07.jpg" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#" title="">
            ...
            <div class="row">
                <?php foreach ($topbuyedproducts as $key => $topbuyedproduct): ?>
                    ...
                    <div class="product-box">
                        <div class="imagebox">
                            <?php $image_list =$topbuyedproduct->image_list != NULL ? json_decode($topbuyedproduct->image_list->load()) : NULL;?>
                            <ul class="box-image <?php if(is_array($image_list)):?> owl-carousel-1 <?php endif;?>">
                                <li>
                                    <a href="<?php echo base_url('product/detail/'.$topbuyedproduct->id)?>" title="">
                                        <img src="<?php echo base_url('upload/product/'.$topbuyedproduct->image_link);?>" alt="">
                                    </a>
                                </li>
                            ...
                            <div class="box-content">
                                ...
                                <div class="product-name">
                                    <a href="<?php echo base_url('product/detail/'.$topbuyedproduct->id)?>" title=""><?php echo $topbuyedproduct->name; ?></a>
                                </div>
                                <div class="price">
                            ...
                            <div class="box-bottom">
                                <div class="btn-add-cart">
                                    <a href="<?php echo base_url('cart/add/'.$topbuyedproduct->id) ?>" title="">
                                        <img src="<?php echo public_url()?>/front/images/icons/add-cart.png" alt="">Add to Cart
                                    </a>
                                </div>
                                <div class="compare-wishlist">
                ...
                <?php foreach ($allproducts as $key => $allproduct): ?>
                    ...
                    <div class="product-box style1">
                        <div class="imagebox style1">
                            <div class="box-image">
                                <a href="<?php echo base_url('product/detail/'.$allproduct->id)?>" title="">
                                    <img src="<?php echo base_url('upload/product/'.$allproduct->image_link);?>" alt="">
                                </a>
                            </div><!-- /.box-image -->
                            <div class="box-content">
                                <div class="cat-name">
                                ...
                                <div class="product-name">
                                    <a href="<?php echo base_url('product/detail/'.$allproduct->id)?>" title=""><?php echo $allproduct->name; ?></a>
                                </div>
                                <div class="price">
                            ...
                            <div class="box-bottom">
                                ...
                                <div class="btn-add-cart">
                                    <a href="<?php echo base_url('cart/add/'.$allproduct->id) ?>" title="">
                                        Add to Cart
                                    </a>
                                </div>
                            </div><!-- /.box-bottom -->
            ...
            <div class="col-md-12">
                <div class="owl-carousel-3">
                    ...
                    <div class="imagebox style4">
                        <div class="box-image">
                            <a href="<?php echo base_url('product/detail/'.$topviewproduct->id)?>" title="">
                                <img src="<?php echo base_url('upload/product/'.$topviewproduct->image_link);?>" alt="">
                            </a>
                        </div><!-- /.box-image -->
                        <div class="box-content">
                            <div class="cat-name">
                            ...
                            <div class="product-name">
                                <a href="<?php echo base_url('product/detail/'.$topviewproduct->id)?>" title=""><?php echo $topviewproduct->name; ?></a>
                            </div>
                            <div class="price">
